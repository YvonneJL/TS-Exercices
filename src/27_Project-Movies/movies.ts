...
const yUpBtn = document.querySelector("#btn-yup");
const yDownBtn = document.querySelector("#btn-ydown");
...
function putMoviesInDom (movieList: [string, string, string, string, string[], string][]) {
    for (let i = 0; i<=movieList.length-1; i++) {
        const movieDiv = document.createElement("div");
        movieSection?.appendChild(movieDiv);
        movieDiv.className = "bg-yellow-700 p-10 w-64 h-64 mb-5 rounded-3xl text-center text-amber-500";
        const movieName = document.createElement("p");
        movieName.className = "font-bold mb-3"
        movieName.textContent = movieList[i][0];
        const movieYear = document.createElement("p");
        movieYear.textContent = movieList[i][1];
        const movieReg = document.createElement("p");
        movieReg.textContent = movieList[i][2];
        ...
        movieDiv.appendChild(movieReg)
        movieDiv.appendChild(movieLength)
        movieDiv.appendChild(movieGenre)
        movieDiv.appendChild(movieRating)
}};
//& Aufruf der Funktion für das erste Darstellen
...
//..Sobald einer der drei Buttons “YEAR UP”,  “YEAR DOWN”, “BEST RATE” betätigt wird, wird der Suchbegriff aus dem Suchfeld entfernt und eine Sortierung auf alle Filme vorgenommen

//..Wird auf den Button “YEAR UP” geklickt, werden die Filme aufsteigend nach dem Erscheinungsjahr sortiert
//..Wird auf den Button “YEAR DOWN” geklickt, werden die Filme absteigend nach dem Erscheinungsjahr sortiert
//..Wird auf den Button “BEST RATE” geklickt, werden die Filme absteigend nach der Bewertung sortiert
