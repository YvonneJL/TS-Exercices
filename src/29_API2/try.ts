...
//! DIESE datei ist momentan ins Html eingebunden. Hier habe ich die DOM Manipulation in eine r Funktion deklariert--> weniger Code.
//! Aufgedröselt das Ganze noch in der "async.ts"-Datei
...
fetch("https://jsonplaceholder.typicode.com/todos").then((response)=> {
    return response.json().then((data: toDo[])=> {
        ...
        console.log(error);
            ...
            function createElements (data: toDo[]) {
                data.forEach((toDo)=> {
